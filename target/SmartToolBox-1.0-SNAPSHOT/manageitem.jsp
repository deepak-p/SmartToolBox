...
<html>
  ...
  <input type="text" class="form-control input" value="" style="width: 100%">
      ...
      <div id="w-area-aaaq" data-type="area" class="p-164042 n-widget w-area">
        <div id="w-button-aaar" data-type="button" class="n-widget w-button t-button-am08 t-button-am08-black">
          <a href="./index.php?nfssp=edititems" class="w-button-container w-button-fixed" id="w-button-aaar-b">
  ...
  <input type="text" class="form-control input" value="" style="width: 100%">
      ...
      <div id="w-button-aaau" data-type="button" class="n-widget w-button t-button-am08 t-button-am08-black">
        <a href="edititems.jsps" class="w-button-container w-button-fixed" id="w-button-aaau-b">
        <span class="w-button-text"><i class="middle"></i><b class="text">Go</b></span><i class="w-button-right"></i>
        </a>
      </div>
      ...
      <div id="w-button-aaax" data-type="button" class="n-widget w-button t-button-am08 t-button-am08-black">
        <a href="addnewitem.jsp" class="w-button-container w-button-fixed" id="w-button-aaax-b">
        <span class="w-button-text"><i class="middle"></i><b class="text">Go</b></span><i class="w-button-right"></i>
        </a>
      </div>
    </div>
